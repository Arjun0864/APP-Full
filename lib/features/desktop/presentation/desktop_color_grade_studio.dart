            ...
            child: profile == null
                ...
                : ListView(
                    children: [
                      ...
                      const SizedBox(height: 16),
                      _buildSectionHeader(theme, '8-BAND HSL & TARGETS'),
                      _buildHSLBandRow('Red / Lehenga', profile.hslHueShifts[0], profile.hslSatRatios[0], theme),
                      ...
                      _buildHSLBandRow('Green / Leaves', profile.hslHueShifts[3], profile.hslSatRatios[3], theme),
                      _buildHSLBandRow('Cyan / Water', profile.hslHueShifts[4], profile.hslSatRatios[4], theme),
                      _buildHSLBandRow('Blue / Sky', profile.hslHueShifts[5], profile.hslSatRatios[5], theme),
                      _buildHSLBandRow('Purple', profile.hslHueShifts.length > 6 ? profile.hslHueShifts[6] : 0.0, profile.hslSatRatios.length > 6 ? profile.hslSatRatios[6] : 1.0, theme),
                      _buildHSLBandRow('Magenta', profile.hslHueShifts.length > 7 ? profile.hslHueShifts[7] : 0.0, profile.hslSatRatios.length > 7 ? profile.hslSatRatios[7] : 1.0, theme),
